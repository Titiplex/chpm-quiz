        ...
        <div class="page-workspace-main">
          <div class="row g-4">
            <div id="compliance-register" class="page-section col-xl-7">
              ...
              >
                ...
                <div v-else class="compact-list">
                  <div v-for="processing in compliance.register.processing" :key="processing.name" class="compact-list-item p-3 rounded-4 border bg-white">
            ...
            <div id="compliance-retention" class="page-section col-xl-5">
              <CollapsibleSection eyebrow="Conservation" title="Règles MVP" body-class="content-scroll content-scroll-sm">
            ...
            <div id="compliance-export" class="page-section col-xl-5">
              <CollapsibleSection eyebrow="Export pseudonymisé" title="Soumissions sans coffre email" :default-open="false">
                <p class="muted">
            ...
            <div id="compliance-audit" class="page-section col-xl-7">
              <CollapsibleSection eyebrow="Audit consultable" title="Derniers événements sensibles" :default-open="false" body-class="compact">
                <template #default>
